...
# st.write(maill)
prompt = f"Generate an email with only the subject and body for a {tone.lower()} email based on the following context:\n{context}\nFormat: \nSubject: <Subject>\nBody: <Body>"
...
sender=SENDER_MAIL
password="jibs ohun hder uxly"
subject="Hello Girllsss!!!!!"
